...
function HomeDoctors() {
  ...
  return (
    <div className="container mx-auto mt-24 mb-20">
      ...
      <div className="mt-24">
        <div className="flex justify-between rounded-2xl bg-[#5f6fff] p-28 relative">
          <div className="flex flex-col gap-10">
            <h1 className="text-5xl font-bold text-white flex flex-col gap-3">
          ...
          <div className="image w-[400px] absolute -top-5 right-0">
